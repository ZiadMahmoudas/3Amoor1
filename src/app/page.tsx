...
function HeroSection() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* ── Dramatic Scroll indicator — "The Hook is pulling" ── */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <div className="flex items-center gap-3">
          ...
          >
            <svg width="16" height="24" viewBox="0 0 60 90" className="opacity-40">
              <path d="M30 0 L30 40 Q30 70 15 75 Q0 80 5 65 Q8 55 20 55 Q30 55 30 65" stroke="#C80000" strokeWidth="5" fill="none" strokeLinecap="round" />
              <circle cx="7" cy="68" r="4" fill="#E00000" />
            </svg>
          </motion.div>
          <span className="text-gray-400 text-xs font-bold">الهوك هيسحبلك المحتوى — انزل تحت</span>
          <motion.div
            animate={{ y: [0, 12, 0] }}
            transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut', delay: 0.3 }}
          >
            <ChevronDown className="w-4 h-4 text-hook-red/50" />
          </motion.div>
        </div>
      </motion.div>
    </section>
...
function MarqueeSection() {
  ...
  return (
    <div className="py-4 border-y border-white/[0.04] overflow-hidden bg-[#060606]" id="marquee">
...
function AboutSection() {
  return (
    <section id="about" className="py-28 relative overflow-hidden">
      <div className="absolute -top-40 -right-40 w-[400px] h-[400px] bg-hook-red/3 rounded-full blur-[120px]" />
...
function ServicesSection() {
  ...
  return (
    <section id="services" className="py-28 relative">
      <div className="absolute inset-0 bg-gradient-to-b from-hook-red/[0.015] via-transparent to-transparent" />
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
...
function ProcessSection() {
  ...
  return (
    <section id="process" className="py-28 relative overflow-hidden bg-[#060606]">
...
function Footer() {
  return (
    <footer className="border-t border-white/[0.04] pt-16 pb-8 bg-[#060606]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
