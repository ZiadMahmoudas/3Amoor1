export default function HookSvg({ width = 55, height = 100, className = '' }: { width?: number; height?: number; className?: string }) {
  return (
    <svg width={width} height={height} viewBox="0 0 60 110" className={className} fill="none">
      ...
      <path d="M30 50 Q30 82 17 90 Q0 100 5 80 Q8 66 22 63 Q34 60 34 73" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
